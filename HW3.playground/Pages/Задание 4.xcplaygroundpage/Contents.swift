...
let situationAActivity = "Выключить все электрические приборы"
let situationBActivity = "Закрыть входные двери и окна"
let situationCActivity = "Соблюдать спокойствие"

var situation = "C"

switch situation {
case "A":
    print(situationAActivity)
    fallthrough
case "B":
    print(situationBActivity)
    fallthrough
case "C":
    print(situationCActivity)
default:
    print("Кодить")
}
