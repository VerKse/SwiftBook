...
//:Ошибка: Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
 ...
 */
var userAge: Int? // определяю как переменную, а не константу, чтобы не комплиятор не ругался при перепрсиваивании в следующем пункте
userAge = Int(userInputAge)
print(userAge)
//:Значение userAge `nil` т.к. userInputAge содержит не только числовые литералы
...
userAge = Int(userInputAge)
print(userAge!)
//:Без принудительного извлечение вывод со словом Optional
...
userInputAge = "34e"
//print(userInputAge!)
//:Cannot force unwrap value of non-optional type 'String' — ошибка распаковки неопционального типа
